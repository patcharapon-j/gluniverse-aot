...
**2026-09-21, batch E (zone combat) is applied** in PR #20: ADR-0029, decision batches 16 and 17, the zone rules on every surface, the Foundry engine and engagement board, the simulator's spatial model, and a confirming run with 0 missed results (OQ-199 closed). The packet file is updated but its Artifact is not yet republished. Status and open items: `docs/playtest/feedback/round-3/CONTINUATION-HANDOFF.md` section 3.6.
