...
- **Who can Cover:** a soldier who meets all of these:
  ...
  - In a Titan Engagement, they are in the Pushing soldier's zone or an adjacent zone, the same requirement as Help.
...
- In a Titan Engagement:
  ...
  - They are **in the roller's zone or an adjacent zone**, which is what one Position step between two soldiers reads on the field (Chapter 5, section 5.2; `data/engagement/zones.yaml`, `between_soldiers`; decision batch 16, 16-11). This is the Position requirement ADR-0024 (limit 7) asks for.
