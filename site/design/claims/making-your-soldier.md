...
- Pools: full pool, one dice Talent naming the entry, Bonus Dice only from Trial 3 Help, Gear Dice from the listed item, Stress Dice; rule Talents apply; only Trial 3 can be Pushed. C 357; GE 44-49
...
- Acts are Catalog entries plus Push; Covering is the Cover entry. C 422; EN 29-32
...
- Kinds: action (your action in a Titan Engagement or Skirmish); reaction (Titan or Foe acts against you, outside your turn, spends a turn, not an action); roll (attribute roll when called, not an action, spends no turn); option (use of another entry or rule, not action or roll, spends nothing unless stated); fixed roll (not an attribute roll; Fear Roll, Stress Response roll, Gas Roll; never Talent dice; only rule Talents name it). C 522, 576, 586; AC 13-26
- Entries state rolled (when taken, when a rule calls, never), attribute, gear (pick one), requires gear, context, requirements and needs, changes, Help outside a Titan Engagement; owning chapter gives procedure. C 520-533, 551; AC 27-46
...
- Spot, Survive, Endure on Legs and Night Camp; Persuade, Recall, Size Up for Requisition and Skirmish; Sneak for the ambush. C 574, 588
...
- Outside the Catalog (Fig. 3): name the one value; description never limits; value alone decides; none means no roll, no effect; Position or Engaged and Apart is a move (Fighting Titans, Skirmishes), stop; list every entry that changes it, meet requirements of one, pick; that entry for every purpose (kind, attribute, gear, needs, effect, cost, Talents); apply gear rule, not possible cannot be used; no usable entry: rule-named value rolls its named attribute alone, otherwise no roll and no effect. C 599-605; AC 928-958
- Rule-created clock, counter, obstacle: names the entries or the attribute roll; attribute alone, no Talent dice, Gear only from a named item. C 607, 609; AC 102-103, 959-963
- No rulings: GM never decides possibility, entry, or change; steps decide; no-value acts described freely, no effect. C 611; AC 964-968
- Examples (Jonas): torn cloak is Treat Injury, Wits alone; shout naming Reaction dice needs Call It and a Read, no effect; naming a comrade's roll is Help; prayer needs Downtime Action, only in Downtime, no effect. C 615-617
...
- Actions: every entry a PC can take as an action incl. Help and options such as Call It; meets requirements; Specialty never limits; uses outside-Catalog steps; only Reaction is the dodge; makes called rolls (Fly, Ride, Death Roll); never Pushes or Covers; own Reaction spends own turn, on a Wing the turn right after its PC's. C 690-693; SQ 71-85; SP 20-24
...
- Directing: any player proposes; on a Wing, that PC's player decides; off a Wing, D6 roll-off by a proposer, highest decides, ties again; GM never directs. C 707-710; SQ 97-103
