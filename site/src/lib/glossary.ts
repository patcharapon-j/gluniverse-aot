...
const RAW: { term: string; chapter: ChapterId; definition: string; aliases?: string[] }[] = [
  ...
  { term: 'Position', chapter: 'fighting-titans', aliases: ['Positions'], definition: 'Where a soldier is relative to a Focus Titan: Distant, In Reach, On Body, or Blind Spot.' },
  ...
  { term: 'Health', chapter: 'wounds-and-fear', definition: 'Half of Strength plus Agility, rounded up, kept as a row of boxes. Untreated Critical Injuries cross off boxes, damage marks the boxes left, and at 0 you are Down.' },
  ...
  { term: 'ODM move', chapter: 'gear-and-odm', aliases: ['ODM moves'], definition: 'A move you make on your own ODM Gear. It needs a harness that is not Jammed and gas above 0, and it is what makes you airborne.' },
