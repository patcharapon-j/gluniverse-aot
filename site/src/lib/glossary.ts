...
const RAW: { term: string; chapter: ChapterId; definition: string; aliases?: string[] }[] = [
  ...
  { term: 'Anchor Rating', chapter: 'fighting-titans', definition: 'How well a zone holds ODM Gear anchors, from Open to Giant Forest. It sets which attachment steps the zone allows, what a Flight pays to enter it, and the Terrain Trait in play.' },
  { term: 'Field', chapter: 'fighting-titans', definition: 'The hexagonal zones a Titan Engagement is fought over: 7, 13, or 19 of them, with 13 the default.' },
  { term: 'Zone', chapter: 'fighting-titans', aliases: ['Zones'], definition: "One hex of the field, about a Titan's reach across, with its own Anchor Rating, occupants, and effects." },
  { term: 'Edge zone', chapter: 'fighting-titans', aliases: ['Edge zones'], definition: 'A zone on the rim of the field. A soldier steps off field to leave from one.' },
  { term: 'Off field', chapter: 'fighting-titans', definition: 'Beyond the edge zones. A soldier there has left the Titan Engagement and holds no Position.' },
  { term: 'Field rating', chapter: 'fighting-titans', definition: "The Anchor Rating a field is generated from, which the centre zone and the Squad's start zone take." },
  { term: 'Attachment', chapter: 'fighting-titans', definition: 'Where you are within your zone: on the ground, anchored, On Body or in the Blind Spot of a named body, Grabbed, or Pinned. With your zone, it gives every Position you hold.' },
  { term: 'Stride', chapter: 'fighting-titans', definition: "The zones a Focus Titan moves toward its Attention holder before a card resolves a behavior: Small 1, Medium 2, Large 2, and as an Abnormal lists. A grounded Titan's is 0." },
  ...
  { term: 'Position', chapter: 'fighting-titans', aliases: ['Positions'], definition: 'Where you are relative to a Focus Titan or corpse, derived from your zone and attachment: Distant (another zone), In Reach (its zone), On Body, or Blind Spot. An action never changes one. Only your own move does, and the few rules that say so.' },
  ...
  { term: 'Blind Spot', chapter: 'fighting-titans', definition: "Out of a Titan's sight with its Nape within reach, anchored to terrain in its zone, not on the Titan: a tree, a roof, a beam. Blind Spot is a place in the world, not a place on the monster. It is the only Position a Nape strike is made from, and ground with nothing to anchor to has none at all. It has no facing." },
  ...
  },
  {
    ...
    aliases: ['Corpses'],
    definition:
      "A dead Focus Titan's body, lying in the zone it died in for the rest of the fight. Positions relative to it are derived like any body's, it counts as grounded, and it holds no Attention and plays no cards.",
  },
  {
  ...
  { term: 'Momentum', chapter: 'fighting-titans', definition: "Speed you are carrying, from 0 up to the Anchors of the zone you're in. A Flight earns it, Carry, Bite, Brace, Quiet, and a clean line spend it, and a round with no ODM move loses all of it." },
  { term: 'Anchor', chapter: 'fighting-titans', aliases: ['Anchors'], definition: "A zone's anchors, the things worth hooking a line to, set by its Anchor Rating. They cap the Momentum of every soldier in that zone. A wreck takes one rating step off them and nothing puts them back." },
  ...
  { term: 'Move', chapter: 'rules-of-play', definition: "The part of your turn that changes where you are. In a Titan Engagement it is a zone step to an adjacent zone or an attachment step within your own zone, and it can include one mount or dismount." },
