...
const RAW: { term: string; chapter: ChapterId; definition: string; aliases?: string[] }[] = [
  ...
  { term: 'Frenzy', chapter: 'fighting-titans', definition: 'How worked up a Focus Titan is. It starts a fight at 0, gains 1 at the end of each round to a cap of 3, and is added to its behavior roll — so the longer the fight runs, the further down its table it rolls.' },
