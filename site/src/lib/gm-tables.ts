...
const TRACKER_WORDING: Record<string, { name: string; text: string }> = {
  ...
  'focus_titan_row/frenzy-from-0-to-3': {
    name: 'Frenzy',
    text: '0 at the start of the fight, and 1 more at the end of every third round, to a cap of 3. Added to its behavior roll, so the Titan walks down its own table as the fight runs long. Public: say it aloud as it rises.',
  },
