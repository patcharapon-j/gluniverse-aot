  ...
  return [
    {
      ...
      icon: 'roll-push',
      text: 'Gear Dice are never rolled again, so what matters is the 1s they showed on the first roll.',
      exit: { kind: 'stop', label: 'No Push', text: 'A roll you did not Push wears nothing, whatever its Gear Dice showed.' },
    },
    {
      title: 'Count 1 point of wear for each Gear Die showing 1.',
      dice: 'gear:1xl,4l',
      text: 'Wear falls on the item that supplied the dice, and on that item alone.',
      exit: { kind: 'note', label: 'Your horse', text: 'A Pushed roll made with the horse wears the horse, not your ODM Gear.' },
    },
    {
      title: 'A Talent takes points off first.',
      icon: 'talent-rule',
      text: 'Well-Kept Rig, Blade Discipline, and Sure Seat each remove a point before it applies, once per Titan Engagement.',
      exit: { kind: 'cover', label: 'Nothing left', text: 'With every point removed, the item is untouched.' },
    },
    {
      title: 'Lower the current rating by 1 for each point left.',
      icon: 'ph:arrow-down',
